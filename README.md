...
Могу лишь отметить, что Yandex Vision в большей мере не справился с задачей. Он очень неустойчив к различного рода искажениям изображений, а так же к тому, насколько лицо контрастирует с фоном. Face++ by Megvii справился с задачей лучше ожидаемого, не распознавая лишь совсем малые или закрытые более, чем на 70 процентов лица.
...
решение *задачу\** по генерации русскоязычного текста с использованием NLP-модели 
ruGPT-3.
...
<<<<<<< HEAD
* Python + Streamlit
* ruGPT3Small (https://github.com/ai-forever/ru-gpt)
=======
* Python 
* Torch
* NVIDIA CUDA
...
>>>>>>> 8e6db41eded014a8555c7f971762cc415fc40312
